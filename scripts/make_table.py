...
METHOD_ORDER = [
    ...
    "IKC(10)",
    "IKC(20)",
    "FMC-Constrained-Full",
    "FMC-Free-Full",
    "FMC-Constrained-Majority(W)",
    "FMC-Free-Majority(W)",
    "FMC-Constrained-Majority(U)",
    "FMC-Free-Majority(U)",
    "FMC-Constrained-Strict",
    "FMC-Free-Strict",
    "FMRC-Constrained-Full",
    "FMRC-Free-Full",
    "FMRC-Constrained-Majority(W)",
    "FMRC-Free-Majority(W)",
    "FMRC-Constrained-Majority(U)",
    "FMRC-Free-Majority(U)",
    "FMRC-Constrained-Strict",
    "FMRC-Free-Strict",
    "FMRKC-Constrained-Full",
    "FMRKC-Free-Full",
    "FMRKC-Constrained-Majority(W)",
    "FMRKC-Free-Majority(W)",
    "FMRKC-CVC",
    "FMRKC-FVC",
    "FMRKC-Constrained-StrictMajority(W)",
    "FMRKC-Free-StrictMajority(W)",
    "FMRKC-Constrained-StrictMajority(U)",
    "FMRKC-Free-StrictMajority(U)",
    "FMRKC-Constrained-Strict",
    "FMRKC-Free-Strict",
    "MC-MedCon",
    "FMRKC-MedCon",
    "MRKC-CVC",
...
POST_PROC_ORDER = ["None", "+CC", "+WCC", "+CM"]
